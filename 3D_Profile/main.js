...
let projects = [
    {
        image: 'textures/Dashboard.png',
        url: 'https://womanly-tractor.000webhostapp.com/',
    },
    {
        image: 'textures/SocialMedia.png',
        url: 'https://materialuiversion5.000webhostapp.com/',
    },
    {
        image: 'textures/Login.jpg',
        url: 'https://github.com/SOUROVSARKERTEC12/Netflix/tree/master/frontend',
    },
    {
        image: 'textures/Paypal1.jpg',
        url: 'https://github.com/SOUROVSARKERTEC12/paypal_Integrate_HTML',
    },
];
let aboutCameraPos = {
    x: 0.12,
...
gltfLoader.load(
    'models/room.glb',
    function (room) {
        // hide loader on loader
        loaderWrapper.style.display = 'none';

        // load video
        const video = document.createElement('video');
        video.src = 'textures/Tiger3.mp4';
        video.muted = true;
        video.volume = 0.1;
...
function loadIntroText() {
    ...
    loader.load('fonts/unione.json', function (font) {
        ...
        const titleGeo = new TextGeometry('SOUROV SARKAR', {
            font: font,
            size: 0.08,
            height: 0.01,
        });
    ...
    loader.load('fonts/unione.json', function (font) {
        ...
        const titleGeo = new TextGeometry('Never Give Up\nDo Your Duty', {
            font: font,
            size: 0.05,
            height: 0.01,
        });
        titleText = new THREE.Mesh(titleGeo, textMaterials);
        titleText.rotation.y = Math.PI * 0.5;
        titleText.position.set(-.25, 0.25, 1.28);
        scene.add(titleText);
    });
